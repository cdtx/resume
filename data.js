var data = {
    "en": {
        ...
        "education": [
            {
                "title": "MSc in software engineering specialized in embedded software",
                "description": [
                    "Both engineer and research degrees with:",
        ...
        "experiences": [
            ...
            },
            {
                ...
                "description": [
                    ...
                    "    - Impliqué dans les définitions d'architecture",
                    "    - Création d'un framework de communication et de test pour cartes à puces",
                ],
                "keywords": [
                    "C, ARM, AVR, GlobalPlatform, Java Card, NFC, ISO 7816, Cryptography basics, Python, PyScard",
                ],
                "distinctions" : [
                    "Produit VaultSecure certifié conforme par EMVCo"
                ],
                "company": {
                    "name": "Inside Secure",
                    "logo": "insidesecure.png"
